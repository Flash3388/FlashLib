...
public class ActionControlTest {
    ...
    public void isRunning_actionRunning_returnsTrue() throws Exception {
        ...
        Assertions.assertTrue(mActionControl.isActionRunning(action));
    }
    ...
    public void updateActionsForNextRun_withActionsToRemove_requirementsMarkedNoAction() throws Exception {
        ...
        MatcherAssert.assertThat(captor.getAllValues(), IsIterableContainingInAnyOrder.containsInAnyOrder(actions.keySet().toArray()));
    }
    ...
    public void startNewActions_withActionsToStart_updatesRequirements() throws Exception {
        ...
        MatcherAssert.assertThat(captor.getAllValues(), IsIterableContainingInAnyOrder.containsInAnyOrder(actions.toArray()));
    }
