...
public final class Actions {
    ...
    public static ActionInterface wait(Time waitTime) {
        ...
        return new GenericAction.Builder()
                .onConfigure((editor)-> editor.setTimeout(waitTime))
                .build();
    }
     ...
     * use {@link ActionConfigurationEditor#setTimeout(Time)}, add requirements or interrupt the action
     * manually to end it.
     *
    ...
    public static ActionGroup sequential(ActionInterface... actions) {
        return GlobalDependencies.getScheduler().newActionGroup(ActionGroupType.SEQUENTIAL, new ActionConfiguration())
                .add(actions);
    }
    ...
    public static ActionGroup parallel(ActionInterface... actions) {
        return GlobalDependencies.getScheduler().newActionGroup(ActionGroupType.PARALLEL, new ActionConfiguration())
                .add(actions);
    }
    ...
    public static ActionGroup race(ActionInterface... actions) {
        return GlobalDependencies.getScheduler().newActionGroup(ActionGroupType.PARALLEL_RACE, new ActionConfiguration())
                .add(actions);
    }
