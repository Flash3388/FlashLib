...
public class ObsrServerService extends SingleUseService implements ObjectStorage {
    ...
    public ObsrServerService(InstanceId ourId, SocketAddress bindAddress, Clock clock, Logger logger) {
        mLogger = logger;
