...
public class Stick{
	 ...
	 */
	public double getX() {
		return RobotFactory.getImplementation().getHIDInterface().getHIDAxis(stick, axisX);
	}
	/**
	 ...
	 */
	public double getY() {
		return RobotFactory.getImplementation().getHIDInterface().getHIDAxis(stick, axisY);
	}
