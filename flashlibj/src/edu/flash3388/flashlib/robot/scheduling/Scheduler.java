 ...
 * 	<li> {@link #MODE_FULL}: run both tasks and scheduling. A combination of {@link #MODE_TASKS} and {@link #MODE_ACTIONS} </li>
 * </ul>
...
public final class Scheduler {
	 ...
	 * other scheduling use those same systems, those scheduling are canceled. If the scheduler is disabled, the action
	 * cannot be added.
	 * 
