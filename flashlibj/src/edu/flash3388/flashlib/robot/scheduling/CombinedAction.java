...
/**
 * Allows to combine multiple scheduling to run together on the same system. Does not add the scheduling to the Scheduler, but
...
public abstract class CombinedAction extends Action {
	...
	/**
	 * Removes an action from the added scheduling.
