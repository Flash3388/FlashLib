 ...
 * <p>
 * Sequential actions cannot run if another action from the group is active currently. Parallel action will run at all
 * conditions.
 * </p>
 * @author Tom Tzook
...
public class ActionGroup extends Action{
	...
	public ActionGroup(){}
	/**
	 * Creates an action group and adds an array of actions to run sequentially.
	...
	/**
	 * Creates an action group and adds an array of actions to run.
	 * @param actions array of actions to add
	 * @param sequential if true, the actions will run sequentially, otherwise they will run in parallel
	 */
	...
	/**
	 * Adds an array of actions to run sequentially.
	 * 
	...
	/**
	 * Adds an array of actions to run in parallel.
	 * 
	 * @param actions action to run
	 * @return this instance
	 */
