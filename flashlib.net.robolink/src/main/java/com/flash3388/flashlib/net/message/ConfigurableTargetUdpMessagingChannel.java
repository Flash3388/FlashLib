...
public class ConfigurableTargetUdpMessagingChannel implements MessagingChannel {
    ...
    private final AtomicReference<SocketAddress> mSendAddress;
    private final AtomicReference<SocketAddress> mLastReceivedAddress;

    public ConfigurableTargetUdpMessagingChannel(int bindPort,
                                           InstanceId ourId,
        ...
        mSendAddress = new AtomicReference<>(null);
        mLastReceivedAddress = new AtomicReference<>(null);
    }

    public SocketAddress getLastReceivedSenderAddress() {
        return mLastReceivedAddress.get();
    }

    public void setSendTargetAddress(SocketAddress address) {
        mSendAddress.set(address);
    }
