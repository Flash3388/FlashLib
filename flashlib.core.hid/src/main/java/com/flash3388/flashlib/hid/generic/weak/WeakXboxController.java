...
public class WeakXboxController extends WeakHid implements XboxController {

    public WeakXboxController(RawHidInterface hidInterface, int channel) {
    ...
    private static List<Axis> createAxes(RawHidInterface hidInterface, int channel) {
        ...
        for (int i = 0; i < XboxAxis.count(); i++) {
