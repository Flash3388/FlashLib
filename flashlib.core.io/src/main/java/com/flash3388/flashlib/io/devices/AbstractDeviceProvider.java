...
public abstract class AbstractDeviceProvider implements DeviceProvider {
    ...
    private final Map<String, Class<?>> mKnownTypes;
    ...
    @Override
    public <T> Class<? extends T> findDevice(String id, Class<T> type) {
    ...
    protected void registerDevice(String id, Class<?> type) {
